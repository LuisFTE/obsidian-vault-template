...
echo ""
echo -e "  ${YELLOW}Install Obsidian on your phone and/or PC${NC} → https://obsidian.md"
echo -e "  Open your vault repo and install the plugins listed in OBSIDIAN_SETUP.md"
echo ""

...
echo ""
echo -e "${BOLD}One step left:${NC}"
echo ""
echo -e "  ${YELLOW}Install Obsidian${NC} on your phone and/or PC → https://obsidian.md"
echo -e "  Phone-only is fine. PC-only is fine. Both is fine."
echo ""
echo -e "  Once installed, open your vault and follow the plugin setup guide:"
echo -e "  ${BOLD}$VAULT_PATH/OBSIDIAN_SETUP.md${NC}"
echo ""
echo -e "  The agents run in the cloud — Obsidian is just how you write."
echo ""
